...
namespace WebApiFunctionApp
{
    public class ProcessReminders
    {
        [FunctionName("ProcessReminders")]
        public void Run([ServiceBusTrigger("reminders-queue-surya-test", Connection = "REMINDERS_QUEUE_SERVICE_BUS_TEST_CONNECTION_STRING")] string myQueueItem, ILogger log, ExecutionContext context)
        {
